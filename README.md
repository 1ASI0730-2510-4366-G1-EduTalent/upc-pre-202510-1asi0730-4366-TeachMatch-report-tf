...
### Segmento Objetivo 1: Instituciones Educativas:
Desde la perspectiva institucional, se identifica una tendencia hacia la modernización de los procesos de selección y gestión docente, aunque todavía con grandes desafíos pendientes. Actualmente, se combinan métodos tradicionales como la revisión de currículos, entrevistas personales y clases modelo para evaluar a los candidatos. Sin embargo, se reconoce que estos procedimientos no son suficientes para medir competencias blandas ni habilidades digitales, que son cada vez más críticas en el entorno educativo actual.

Las herramientas digitales existentes, como suites colaborativas y sistemas internos de gestión, se utilizan principalmente para la organización documental y de horarios, pero el seguimiento del desempeño docente todavía se realiza de manera manual, lo que genera ineficiencia y sobrecarga administrativa. Desde esta mirada, existe una clara necesidad de automatizar tanto el reclutamiento como la evaluación y la formación continua de los docentes. Además, se destaca la importancia de asegurar que los nuevos docentes no solo cumplan con requisitos técnicos, sino que también estén alineados con los valores institucionales. Se valora especialmente el desarrollo de plataformas que permitan integrar todo el ciclo de vida del docente en la institución, desde su contratación hasta su crecimiento profesional.

### Segmento Objetivo 2: Docentes y practicantes:
Entre los docentes entrevistados, se identifican experiencias diversas respecto a los procesos de postulación y contratación en el ámbito educativo. Una constante en sus testimonios es la percepción de que en el pasado el acceso a plazas docentes dependía más de contactos personales que de procesos formales y abiertos, lo que generaba inequidad. Aunque reconocen que hoy existen más plataformas digitales para buscar empleo, coinciden en que todavía falta mejorar la transparencia y la eficiencia en los procesos de selección, ya que persiste la impresión de que muchas vacantes se asignan antes de ser publicadas.

Los docentes ven con buenos ojos la idea de contar con una plataforma centralizada que permita no solo postular, sino también recibir retroalimentación sobre sus procesos, hacer seguimiento de postulaciones, y acceder a oportunidades de capacitación continua. Además, consideran importante que esta plataforma incluya mecanismos formales de evaluación de habilidades blandas y digitales, como entrevistas automatizadas o pruebas psicométricas. En el caso de los docentes particulares, también se señala la necesidad de contar con un sistema que registre su historial profesional de manera digital para facilitar su presentación ante las instituciones educativas. En general, los docentes valoran cada vez más la formalización, la digitalización y el acceso a formación permanente como elementos fundamentales para su desarrollo profesional.
